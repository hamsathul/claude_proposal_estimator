...
| Requirement | Details |
|-------------|---------|
| Education | BSc/BE minimum, Master/PhD preferred |
...
| Requirement | Details |
|-------------|---------|
| Education | BSc/BE minimum |
| Total Experience | 4-6 years minimum |
| Relevant Experience | 3-4 years in similar projects |
| Special | Hands-on field experience |

## Designer Level (ENG-SD / ENG-D)

| Requirement | Details |
|-------------|---------|
| Education | Diploma/BSc in relevant field |
| Total Experience | 5-8 years for Senior, 3-5 years for Designer |
| Software | AutoCAD, Revit, or relevant design tools |

## Common Requirements (All Levels)

- Fluent in English (reading, writing, speaking)
- Knowledge of international standards and HSE
- Knowledge of information systems
- Degree certified by Ministry of Education (UAE)
- CV and credentials submitted for client review
- Subject to client interview and approval
